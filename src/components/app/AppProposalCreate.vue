            ...
            <div class="dao_form">
                <div class="form">
                    ...
                    <div class="navigation">
                        ...
                        <button v-on:click="deploy()">Create proposal
...
import { createProposal } from '../../scripts/aeternity'
export default {
    data() {
        return {
            proposal: {
    ...
    methods: {
        deploy: async function () {
            ...
            if (this.proposal.summary == '') {
                alert('Enter Proposal sumary')
                return
            }

            if (confirm('Create a new proposal')) {
                const result = await createProposal(
                    this.aeSdk, 
                    this.$route.params.id.replace('ak', 'ct'), 
                    this.proposal
                )
                console.log(result);
            }            
